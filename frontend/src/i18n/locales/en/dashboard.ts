export default {
  dashboard: {
    title: 'Dashboard',
    welcomeMessage: "Welcome back! Here's a summary of your account.",
    balance: 'Balance',
    apiKeys: 'API Keys',
  ...
  keys: {
    ...
    failedToSave: 'Could not save API key',
    failedToDelete: 'Could not delete API key',
    failedToUpdateStatus: 'Could not update API key status',
    clickToChangeGroup: 'Click to change group',
    groupChangedSuccess: 'Group changed successfully',
    failedToChangeGroup: 'Could not change group',
    ...
    useKeyModal: {
      title: 'Use API Key',
      description:
        'Add the following environment variables to your terminal profile or run them directly in terminal to configure API access.',
      copy: 'Copy',
      copied: 'Copied',
    ...
    failedToResetRateLimit: 'Could not reset rate limit usage',
  ...
  usage: {
    ...
    failedToLoad: 'Could not load usage logs',
    noDataToExport: 'No data to export',
    exportSuccess: 'Usage data exported successfully',
    exportFailed: 'Could not export usage data',
    exportExcelSuccess: 'Usage data exported successfully (Excel format)',
    exportExcelFailed: 'Could not export usage data',
    imageUnit: ' images',
    ...
    ipGeo: {
      ...
      batchFailed: 'Could not batch fetch IP regions',
      detailOrg: 'ISP',
    ...
    errors: {
      ...
      empty: 'No error requests', failedToLoad: 'Could not load error requests',
      categories: {
      ...
      detail: {
        ...
        loadFailed: 'Could not load detail, please try again',
      },
    },
  },
  ...
  channelStatus: {
    ...
    detailLoadError: 'Could not load channel detail',
  ...
  affiliate: {
    ...
    loadFailed: 'Could not load affiliate data',
    transferFailed: 'Could not transfer affiliate quota',
    stats: {
  ...
  redeem: {
    ...
    failedToRedeem: 'Could not redeem code. Please check the code and try again.',
    subscriptionRefreshFailed: 'Redeemed successfully, but could not refresh subscription status.',
  ...
  profile: {
    ...
    totp: {
      ...
      verify: 'Verify',
      setupFailed: 'Could not get setup information',
      ...
      disableFailed: 'Could not disable, please check your password',
    ...
    avatar: {
      ...
      compressFailed: 'Could not compress the selected image.',
