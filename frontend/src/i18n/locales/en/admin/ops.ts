export default {
    ops: {
      ...
      description: 'Operational monitoring and issue triage',
      // Dashboard
      systemHealth: 'System Health',
      overview: 'Overview',
      noSystemMetrics: 'No system metrics have been collected yet.',
      ...
      jobs: 'Jobs',
      jobsHelp: 'Click “Details” to inspect job heartbeats and recent errors',
      active: 'active',
      idle: 'idle',
      waiting: 'waiting',
      conns: 'conns',
      ...
      systemLogs: {
        ...
        search: 'Search',
        cleanCurrentFilters: 'Clear current filters',
        refreshHealth: 'Refresh health',
        empty: 'No system logs',
        time: 'Time',
        logDetails: 'Log Details',
        loadFailed: 'Could not load system logs',
        runtimeConfigActive: 'Runtime log configuration is active',
        runtimeConfigSaveFailed: 'Could not save log configuration',
        resetRuntimeConfigConfirm: 'Reset to the startup configuration (env/yaml) and apply immediately?',
        runtimeConfigReset: 'Reset to startup log configuration',
        runtimeConfigResetFailed: 'Could not reset log configuration',
        cleanupConfirm: 'Clean up system logs that match the current filters? This cannot be undone.',
        cleanupSuccess: 'Cleanup complete. Deleted {count} log entries.',
        cleanupFailed: 'Could not clean up system logs'
      },
      ...
      failedToLoadData: 'Could not load ops data.',
      failedToLoadOverview: 'Could not load overview',
      failedToLoadThroughputTrend: 'Could not load throughput trend',
      failedToLoadSwitchTrend: 'Could not load avg account switches trend',
      failedToLoadLatencyHistogram: 'Could not load request duration histogram',
      failedToLoadErrorTrend: 'Could not load error trend',
      failedToLoadErrorDistribution: 'Could not load error distribution',
      failedToLoadErrorDetail: 'Could not load error detail',
      ...
      healthHelp: 'Overall system health score derived from SLA, error rate, and resource usage',
      ...
      openaiTokenStats: {
        ...
        failedToLoad: 'Could not load OpenAI token stats',
      ...
      diagnosis: {
        ...
        dbDownAction: 'Check the database service status, network connectivity, and connection configuration',
        redisDown: 'Redis connection failed',
        redisDownImpact: 'Cache functionality degraded; performance may drop',
        redisDownAction: 'Check the Redis service status and network connectivity',
        cpuCritical: 'CPU usage critically high ({usage}%)',
        cpuCriticalImpact: 'System response is slowing and may affect every request',
        cpuCriticalAction: 'Inspect CPU-intensive tasks; consider scaling or code optimization',
        cpuHigh: 'CPU usage elevated ({usage}%)',
        cpuHighImpact: 'System load is high and needs attention',
        cpuHighAction: 'Watch CPU trends and prepare a scaling plan',
        memoryCritical: 'Memory usage critically high ({usage}%)',
        memoryCriticalImpact: 'May trigger OOM; system stability is threatened',
        memoryCriticalAction: 'Look for memory leaks; consider adding memory or optimizing usage',
        memoryHigh: 'Memory usage elevated ({usage}%)',
        memoryHighImpact: 'Memory pressure is high and needs attention',
        memoryHighAction: 'Watch memory trends and check for memory leaks',
        ttftHigh: 'Time to first token elevated ({ttft}ms)',
        ttftHighImpact: 'User-perceived latency has increased',
        ttftHighAction: 'Optimize the request processing flow and cut pre-processing time',
        ...
        upstreamCriticalAction: 'Check upstream service health and enable fallback strategies',
        upstreamHigh: 'Upstream error rate elevated ({rate}%)',
        upstreamHighImpact: 'Worth checking the upstream service status',
        upstreamHighAction: 'Contact the upstream service team and prepare a fallback plan',
        errorHigh: 'Error rate too high ({rate}%)',
        errorHighImpact: 'Many requests are failing',
        errorHighAction: 'Check error logs, identify the root cause; an urgent fix is required',
        errorElevated: 'Error rate elevated ({rate}%)',
        errorElevatedImpact: 'Worth checking the error logs',
        errorElevatedAction: 'Analyze error types and distribution, then plan a fix',
        // SLA diagnostics
        slaCritical: 'SLA critically below target ({sla}%)',
        slaCriticalImpact: 'User experience is severely degraded',
        ...
        slaLowAction: 'Analyze why SLA dropped and optimize system performance',
        ...
        healthCriticalAction: 'Run a comprehensive system check and prioritize critical-level issues',
        healthLow: 'Overall health score low ({score})',
        healthLowImpact: 'May indicate minor instability; monitor SLA and error rates',
        healthLowAction: 'Watch metric trends and prevent the issue from escalating',
        healthy: 'All system metrics normal',
        healthyImpact: 'Service is running stable'
      },
      // Error Log
      errorLog: {
        timeId: 'Time / ID',
      ...
      errorDetail: {
        ...
        resolution: 'Resolved:',
        failedToUpdateResolvedStatus: 'Could not update resolved status',
        classificationKeys: {
          phase: 'Phase',
          owner: 'Owner',
          source: 'Source',
        ...
        suggestUpstream: 'Upstream instability: check the account status or consider switching accounts',
        suggestRequest: 'Client request error: ask the customer to fix the request parameters',
        suggestAuth: 'Auth failed: verify the API key/credentials',
        suggestPlatform: 'Platform error: prioritize investigation and fix',
        suggestGeneric: 'See the details for more context',
      ...
      requestDetails: {
        ...
        failedToLoad: 'Could not load request details',
      ...
      alertEvents: {
        ...
        loadFailed: 'Could not load alert events',
        status: {
          firing: 'FIRING',
          resolved: 'RESOLVED',
        ...
        detail: {
          ...
          empty: 'No detail',
          loadFailed: 'Could not load alert detail',
          manualResolve: 'Mark as Resolved',
          manualResolvedSuccess: 'Marked as manually resolved',
          manualResolvedFailed: 'Could not mark as manually resolved',
          silence: 'Ignore Alert',
          silenceSuccess: 'Alert silenced',
          silenceFailed: 'Could not silence alert',
          viewRule: 'View Rule',
          viewLogs: 'View Logs',
          firedAt: 'Fired At',
          resolvedAt: 'Resolved At',
          ...
          historyHint: 'Recent events sharing the same rule + dimensions',
      ...
      alertRules: {
        ...
        loadFailed: 'Could not load alert rules',
        saveFailed: 'Could not save alert rule',
        saveSuccess: 'Alert rule saved successfully',
        deleteFailed: 'Could not delete alert rule',
        ...
        deleteConfirmMessage: 'This removes the rule along with its related events. Continue?',
        metricGroups: {
        ...
        hints: {
          ...
          groupOptional: 'Optional: restrict the rule to a specific group via group_id.'
        },
        table: {
          name: 'Name',
          metric: 'Metric',
      ...
      runtime: {
        ...
        description: 'Stored in the database; changes take effect without editing config files.',
        loading: 'Loading...',
        noData: 'No runtime settings available',
        loadFailed: 'Could not load runtime settings',
        saveSuccess: 'Runtime settings saved',
        saveFailed: 'Could not save runtime settings',
      ...
      email: {
        ...
        description: 'Configure alert/report email notifications (stored in the database).',
        loading: 'Loading...',
        noData: 'No email notification config',
        loadFailed: 'Could not load email notification config',
        saveSuccess: 'Email notification config saved',
        saveFailed: 'Could not save email notification config',
        alertTitle: 'Alert Emails',
        reportTitle: 'Report Emails',
        recipients: 'Recipients',
        recipientsHint: 'If empty, the system may fall back to the first admin email.',
        ...
        reportHint: 'Schedules use cron syntax; leave empty to use the defaults.',
        validation: {
          title: 'Please fix the following issues',
          ...
          cronRequired: 'A cron expression is required when the schedule is enabled',
      ...
      settings: {
        ...
        evaluationIntervalHint: 'Frequency of detection tasks; keeping the default is recommended',
        alertConfig: 'Alert Configuration',
        enableAlert: 'Enable Alerts',
        alertRecipients: 'Alert Recipient Emails',
        emailPlaceholder: 'Enter an email address',
        recipientsHint: 'If empty, the system uses the first admin email as the default recipient',
        ...
        metricThresholdsHint: 'Configure alert thresholds for metrics; values beyond a threshold are shown in red',
        ...
        ignoreCountTokensErrorsHint: 'When on, errors from count_tokens requests are not written to the error log.',
        ignoreContextCanceled: 'Ignore client disconnect errors',
        ignoreContextCanceledHint: 'When on, client disconnect (context canceled) errors are not written to the error log.',
        ignoreNoAvailableAccounts: 'Ignore no-available-accounts errors',
        ignoreNoAvailableAccountsHint: 'When on, "No available accounts" errors are not written to the error log (not recommended; usually a config issue).',
        ignoreInvalidApiKeyErrors: 'Ignore invalid API key errors',
        ignoreInvalidApiKeyErrorsHint: 'When on, invalid or missing API key errors (INVALID_API_KEY, API_KEY_REQUIRED) are not written to the error log.',
        ignoreInsufficientBalanceErrors: 'Ignore Insufficient Balance Errors',
        ignoreInsufficientBalanceErrorsHint: 'When on, insufficient account balance errors are not written to the error log.',
      ...
      concurrency: {
        ...
        byUser: 'By User',
        showByUserTooltip: 'Switch to the user view to see concurrency usage per user',
        ...
        loadFailed: 'Could not load concurrency data'
      },
      realtime: {
        title: 'Realtime',
      ...
      tooltips: {
        ...
        throughputTrend: 'Requests/QPS + Tokens/TPS within the selected window.',
        ...
        goroutines:
          'Number of Go runtime goroutines (lightweight threads). There is no absolute "safe" number — use your historical baseline. Heuristic: <2k is common; 2k–8k worth watching; >8k combined with a rising queue/latency often signals blocking or leaks.',
        ...
        latency: 'Request duration statistics, including p50, p90, p95, and p99 percentiles.',
        ttft: 'Time To First Token, measuring how fast the first token returns in streaming responses.',
        health: 'System health score (0-100), factoring in SLA, error rate, and resource usage.'
      },
      charts: {
        ...
        downloadChartHint: 'Download the chart as an image'
      }
    },
