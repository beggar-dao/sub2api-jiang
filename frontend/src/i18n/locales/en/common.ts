export default {
  common: {
    ...
    peakRateImageNote: '; tokens billed as image tokens are also affected, per-image billing is unaffected',
    save: 'Store',
    saved: 'Stored successfully',
    deleted: 'Removed',
    cancel: 'Cancel',
    delete: 'Remove',
    edit: 'Edit',
  ...
  adminCompliance: {
    ...
    blockingNotice: 'You must complete the deployment and operation compliance acknowledgment before continuing to use the console.',
    riskNotice: 'This acknowledgment gives clear, prominent, and reproducible notice of compliance obligations and operational risks for self-hosted instances.',
    version: 'Document Version',
    openDocument: 'Open the GitHub document',
    documentSource: 'The agreement text is sourced from Markdown files in this project repository. Whenever the agreement content changes, the document version must be incremented; acknowledgments of earlier versions become invalid and console users must acknowledge again.',
    ...
    legalNote: 'This acknowledgment defines the no-affiliation relationship and responsibility boundary between self-hosted instances and the open-source project, copyright holders, contributors, and maintainers. The party that deploys, operates, or controls the relevant instance remains solely responsible for its applicable obligations.',
    logout: 'Log out',
    accept: 'Acknowledge and Continue',
    accepted: 'Compliance acknowledgment recorded',
    acceptFailed: 'Could not submit acknowledgment'
  },
  ...
  legal: {
    ...
    loginAgreementPrompt: {
      ...
      noticeDescription: 'Account/password login and quick sign-in remain disabled until you accept.',
  ...
  auth: {
    ...
    sessionExpiredDesc: 'Please go back to the registration page and start over.',
    ...
    sendCodeFailed: 'Could not send verification code. Please try again.',
    ...
    linuxdo: {
      ...
      invitationRequired: 'This Linux.do account is not yet registered. The site requires an invitation code — please enter one to finish registration.',
    ...
    dingtalk: {
      ...
      callbackMissingToken: 'Missing login token, please try again.',
      backToLogin: 'Back to Login',
      invitationRequired: 'This DingTalk account is not yet registered. The site requires an invitation code — please enter one to finish registration.',
      ...
      error: {
        ...
        session_error: 'Could not create session. Please retry',
        retry: 'Retry Login'
      }
    },
    emailOAuth: {
    ...
    oidc: {
      ...
      backToLogin: 'Back to Login',
      invitationRequired:
        'This {providerName} account is not yet registered. The site requires an invitation code — please enter one to finish registration.',
    ...
    oauthFlow: {
      ...
      wechatNotConfigured: 'WeChat sign-in has not been configured yet.'
    },
    ...
    sendResetLinkFailed: 'Could not send reset link. Please try again.',
