export default {
    availableChannels: {
      title: '可使用渠道',
      description: '按渠道汇总查看关联分组及支持模型（通配符已展开）',
      searchPlaceholder: '检索渠道或模型...',
      columns: {
        name: '渠道名称',
        status: '当前状态',
        billingSource: '计费模型出处',
        groups: '关联的分组',
      ...
      billingSource: {
        requested: '请求的模型',
        upstream: '上游的模型',
        channel_mapped: '映射后的模型'
      },
      pricing: {
        billingMode: '计费方式',
        billingModeToken: '按 Token',
        billingModePerRequest: '按次数',
    ...
    channels: {
      ...
      groupsUnit: '个分组',
      pricingUnit: '条定价',
      noChannelsYet: '当前没有渠道',
      createFirstChannel: '创建首个渠道以管理模型定价',
      loadError: '渠道列表加载未成功',
      createSuccess: '渠道创建完成',
      updateSuccess: '渠道更新完成',
      deleteSuccess: '渠道已删除',
      createError: '创建渠道未成功',
      updateError: '更新渠道未成功',
      deleteError: '删除渠道未成功',
      nameRequired: '请填写渠道名称',
      duplicateModels: '模型「{0}」在多个定价条目中出现重复',
      modelConflict: "模型模式 '{model1}' 与 '{model2}' 存在冲突：匹配范围重叠。模型名称按大小写不敏感匹配，已有条目已覆盖其所有大小写变体，无需重复添加。",
      mappingConflict: "模型映射源 '{model1}' 与 '{model2}' 存在冲突：匹配范围重叠。源模式按大小写不敏感匹配，已有条目已覆盖其所有大小写变体。",
      intervalValidation: {
        negativeMin: '区间 #{index}：最小 token 数（{value}）不可为负数',
        maxPositive: '区间 #{index}：最大 token 数（{value}）必须大于 0',
        maxGreaterThanMin: '区间 #{index}：最大 token 数（{max}）必须大于最小 token 数（{min}）',
        negativePrice: '区间 #{index}：{field}不可为负数',
        unboundedLast: '区间 #{index}：无上限区间（最大 token 数留空）必须置于末尾',
        overlap: '区间 #{previousIndex} 与 #{currentIndex} 重叠：前一区间上界（{previousMax}）大于当前区间下界（{currentMin}）',
        price: {
          inputPrice: '输入价格',
          outputPrice: '输出价格',
      ...
      deleteConfirm: '确定要移除渠道「{name}」吗？此操作不可撤销。',
      columns: {
        name: '名称',
        description: '描述',
        status: '状态',
      ...
      form: {
        name: '名称',
        namePlaceholder: '填写渠道名称',
        description: '描述',
        descriptionPlaceholder: '可选的描述',
        status: '状态',
        groups: '关联的分组',
        noGroupsAvailable: '当前没有可用分组',
        inOtherChannel: '已归属「{name}」',
        modelPricing: '模型定价',
        models: '模型列表',
        modelsPlaceholder: '填写完整模型名后按回车添加',
        ...
        addInterval: '新增区间',
        requestTiers: '按次计费层级',
        imageTiers: '图片计费层级（按次数）',
        addTier: '新增层级',
        noTiersYet: '当前没有层级，点击新增以配置按次计费价格',
        noPricingRules: '当前没有定价规则，点击"新增"创建',
        perRequestPrice: '单次价格',
        ...
        noMappingRules: '当前没有映射规则，点击"新增"创建',
        mappingSource: '源模型',
        mappingTarget: '目标模型',
        ...
        syncModelsError: '同步模型未成功'
      }
    },

    riskControl: {
      title: '风控中心',
      description: '配置内容审计策略并查看审核日志',
      loadFailed: '风控中心加载未成功',
      saveFailed: '内容审计配置保存未成功',
      logsFailed: '审核记录加载未成功',
      saved: '内容审计配置已保存',
      refresh: '刷新',
      config: '内容审计配置',
      configHint: '调用 OpenAI Moderations 对请求内容进行评分，命中阈值后按模式处理。',
      openSettings: '内容审计设置',
      settingsTitle: '内容审计设置',
      refreshStatus: '刷新状态',
      records: '审核记录',
      recordsHint: '展示命中、拦截、异常及已采样记录。',
      saveConfig: '保存内容审计配置',
      statusFailed: '运行状态加载未成功',
      enabled: '开启内容审计',
      ...
      apiKeysHint: '当前已保存 {count} 个 Key；输入区仅用于新增，保存时会增量追加并自动去重。',
      ...
      apiKeysReplaceNoInput: '覆盖保存至少需要填写 1 个 API Key',
      ...
      deleteApiKey: '移除这个 Key',
      undoDeleteApiKey: '撤销移除',
      ...
      testingApiKeys: '测试中',
      apiKeyTestNoInput: '请先填写需要测试的 OpenAI API Key',
      apiKeyTestDone: 'Key 测试完成，共 {count} 个',
      apiKeyTestFailed: '测试 OpenAI API Key 未成功',
      ...
      auditTestPromptPlaceholder: '填写要测试的用户提示词；留空时仅测试 Key 可用性。',
      auditTestImages: '测试图片',
      auditTestImagesHint: '支持上传、拖拽或粘贴图片，最多 1 张，每张不超过 8MB。',
      addAuditTestImage: '新增图片',
      clearAuditTest: '清空试跑',
      auditTestImageLimit: '最多只能新增 {count} 张测试图片',
      auditTestImageTooLarge: '单张测试图片不可超过 8MB',
      auditTestImageReadFailed: '读取测试图片未成功',
      ...
      flaggedHashDeleteFailed: '删除风险哈希未成功',
      flaggedHashesCleared: '已清空 {count} 个风险哈希',
      flaggedHashesClearFailed: '清空风险哈希未成功',
      ...
      queueDelay: '排队 {ms} ms',
      allGroups: '所有分组',
      allGroupsHint: '当前审计所有分组',
      selectedGroupsHint: '当前审计指定分组',
      groupScope: '审计分组',
      groupScopeHint: '开启右侧开关表示所有分组，关闭后选择指定分组。',
      selectedGroups: '指定分组',
      searchGroups: '检索分组名称或平台',
      noGroups: '当前没有可用分组',
      modelFilter: '模型范围',
      ...
      preBlockErrors: '审核异常',
      preBlockErrorsHint: '未成功或无可用 Key',
      ...
      preBlockAPIKeyLoadEmpty: '当前没有审核 Key 负载数据',
      ...
      blockedKeywordsPlaceholder: '每行填写一个关键词，例如：\n敏感词1\n敏感词2',
    ...
    channelMonitor: {
      title: '渠道监控',
      description: '监测各渠道的可用性、延迟及状态',
      searchPlaceholder: '检索监控名称...',
      allProviders: '所有供应商',
      allStatus: '所有状态',
      enabledFilter: '启用状态',
      onlyEnabled: '仅启用',
      ...
      runSuccess: '检测完成',
      runFailed: '检测未成功',
      apiKeyDecryptFailed: 'API Key 解密未成功，请重新编辑该监控并填入新的 Key',
      createSuccess: '监控创建完成',
      updateSuccess: '监控更新完成',
      deleteSuccess: '监控已删除',
      loadError: '监控列表加载未成功',
      deleteConfirm: '确定要移除监控「{name}」吗？此操作不可撤销。',
      nameRequired: '请填写监控名称',
      primaryModelRequired: '请填写主模型',
      columns: {
        name: '名称',
        provider: '供应商',
        primaryModel: '主模型',
      ...
      form: {
        ...
        extraModels: '附加模型',
        extraModelsPlaceholder: '回车新增附加模型',
        groupName: '分组名称',
        groupNamePlaceholder: '可选，用于在用户视图中聚合展示',
      ...
      runResultTitle: '检测结果',
      noMonitorsYet: '当前没有监控',
      createFirstMonitor: '创建首个监控以跟踪渠道可用性',
      advanced: {
        section: '高级（可选）',
        ...
        bodyJsonError: 'JSON 解析未成功',
        bodyJsonObjectError: '请求体必须是一个 JSON 对象（不可是数组或基本类型）'
      },
      templateField: {
        label: '请求模板',
        none: '不使用模板',
      ...
      template: {
        ...
        missingName: '请填写模板名称',
        createSuccess: '模板创建完成',
        updateSuccess: '模板更新完成',
        deleteSuccess: '模板已删除',
        applyButton: '应用到关联监控',
        ...
        deleteConfirm: '确定要移除模板「{name}」吗？{n} 个关联监控会解除关联但保留各自的快照继续工作。',
        ...
        form: {
          ...
          description: '说明',
          descriptionPlaceholder: '可选：说明这个模板的用途及来源（抓包日期等）'
        }
      }
    },
    ...
    subscriptions: {
      ...
      resetQuotaConfirm: "确定要重置 '{user}' 的每日、每周及每月用量配额吗？用量将归零并从今天开始重新计算。",
      quotaResetSuccess: '配额重置完成',
      failedToResetQuota: '重置配额未成功',
      noSubscriptionsYet: '当前没有订阅',
      assignFirstSubscription: '分配一个订阅以开始使用。',
      subscriptionAssigned: '订阅分配完成',
      subscriptionAdjusted: '订阅调整完成',
      subscriptionRevoked: '订阅撤销完成',
      subscriptionRestored: '订阅已恢复',
      failedToLoad: '订阅列表加载未成功',
      failedToAssign: '分配订阅未成功',
      failedToAdjust: '调整订阅未成功',
      failedToRevoke: '撤销订阅未成功',
      failedToRestore: '恢复订阅未成功',
      adjustWouldExpire: '调整后剩余天数必须大于 0',
      adjustOutOfRange: '调整天数必须在 -36500 到 36500 之间',
      pleaseSelectUser: '请选择用户',
      pleaseSelectGroup: '请选择分组',
      validityDaysRequired: '请填写有效的天数（至少 1 天）',
