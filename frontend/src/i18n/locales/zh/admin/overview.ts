export default {
    ...
    dashboard: {
      ...
      groupDistribution: '分组用量分布',
      metricTokens: '按 Token',
      metricActualCost: '按实际消费',
      tokenUsageTrend: 'Token 使用走势',
      noDataAvailable: '当前没有数据',
      model: '模型',
      group: '分组',
      noGroup: '无分组',
      requests: '请求',
      ...
      viewSpendingRanking: '用户消费排行',
      spendingRankingTitle: '用户消费排行',
      ...
      tokensShort: 'Token',
      last7Days: '最近 7 天',
      noUsageRecords: '当前没有使用记录',
      startUsingApi: '开始调用 API 后，使用记录会展示在此处。',
      viewAllUsage: '查看全部',
      quickActions: '常用操作',
      manageUsers: '用户管理',
      viewUserAccounts: '查看并管理用户账户',
      manageAccounts: '账号管理',
      configureAiAccounts: '配置 AI 平台账号',
      batchImage: '批量生图',
      batchImageDesc: '提交任务、复制 Agent 调用说明',
      groupPricing: '分组定价',
      groupPricingDesc: '设置批量折扣与冻结比例',
      systemSettings: '系统设置',
      configureSystem: '配置系统参数',
      failedToLoad: '仪表盘数据加载未成功'
    },

    backup: {
      title: '数据库备份',
      description: '将整库备份至 S3 兼容存储，支持定时备份与恢复',
      s3: {
        title: 'S3 存储配置',
        ...
        secretConfigured: '已配置，留空表示沿用原值',
        forcePathStyle: '强制路径风格',
        testConnection: '测试连接',
        testSuccess: 'S3 连接测试通过',
        testFailed: 'S3 连接测试未成功',
        saved: 'S3 配置已存储'
      },
      schedule: {
        title: '定时备份',
        description: '配置自动定时备份策略',
        enabled: '启用定时备份',
        cronExpr: 'Cron 表达式',
        cronHint: '例如 "0 2 * * *" 表示每天凌晨 2 点执行',
        retainDays: '备份过期天数',
        retainDaysHint: '备份文件超过此天数会自动删除，0 = 永不过期',
        retainCount: '最大保留份数',
        retainCountHint: '最多保留的备份份数，0 = 不限制',
        saved: '定时备份配置已存储'
      },
      operations: {
        title: '备份记录',
        description: '手动创建备份并管理已有备份记录',
        createBackup: '创建备份',
        backing: '正在备份...',
        backupCreated: '备份已创建',
        expireDays: '过期天数',
        alreadyInProgress: '已有备份正在进行',
        backupRunning: '正在执行备份...',
        backupFailed: '备份未成功',
        restoreRunning: '正在执行恢复...',
        restoreFailed: '恢复未成功',
      },
      columns: {
        status: '状态',
      ...
      actions: {
        download: '下载',
        restore: '恢复',
        restoreConfirm: '确定用此备份执行恢复吗？该操作会覆盖当前数据库！',
        restorePasswordPrompt: '请填写管理员密码以确认恢复',
        restoreSuccess: '数据库已恢复成功',
        deleteConfirm: '确定要删除这条备份吗？',
        deleted: '备份已删除'
      },
      r2Guide: {
        title: 'Cloudflare R2 配置教程',
        intro: 'Cloudflare R2 提供 S3 兼容的对象存储，免费额度包含 10GB 存储 + 每月 100 万次 A 类请求，很适合用于数据库备份。',
        step1: {
          title: '创建 R2 存储桶',
          line1: '登录 Cloudflare Dashboard (dash.cloudflare.com)，在左侧菜单选择「R2 对象存储」',
          line2: '点击「创建存储桶」，填写名称（如 sub2api-backups）并选择区域',
          line3: '点击创建即可完成'
        },
        step2: {
          title: '创建 API 令牌',
          line1: '在 R2 页面，点击右上角的「管理 R2 API 令牌」',
          line2: '点击「创建 API 令牌」，权限选择「对象读和写」',
          line3: '建议限定存储桶范围（仅允许访问备份桶，更安全）',
          line4: '创建完成后会显示 Access Key ID 与 Secret Access Key',
          warning: 'Secret Access Key 仅展示一次，请立刻复制保存！'
        },
        step3: {
          title: '获取 S3 端点地址',
          desc: '在 R2 概览页面找到你的账户 ID（位于 URL 或右侧面板），端点格式为：',
          accountId: '你的账户 ID'
        },
        step4: {
          title: '填写以下配置',
        ...
        freeTier: 'R2 免费额度：10GB 存储 + 每月 100 万次 A 类请求 + 1000 万次 B 类请求，对数据库备份绰绰有余。'
      }
    },

    dataManagement: {
      title: '数据管理',
      description: '集中管理数据管理代理状态、对象存储配置及备份任务',
      agent: {
        title: '数据管理代理状态',
        description: '系统会自动探测固定的 Unix Socket，仅在可连通时才启用数据管理功能。',
        enabled: '数据管理代理已就绪，可继续执行数据管理操作。',
        disabled: '数据管理代理不可用，当前仅能查看诊断信息。',
        ...
        reason: {
          ...
          DATA_MANAGEMENT_AGENT_UNAVAILABLE: '数据管理代理无法连通',
          BACKUP_AGENT_SOCKET_MISSING: '未检测到备份 Socket 文件',
          BACKUP_AGENT_UNAVAILABLE: '备份代理无法连通',
          UNKNOWN: '未知原因'
        }
      },
      sections: {
        config: {
          title: '备份配置',
          description: '配置备份源、保留策略及 S3 存储参数。'
        },
        s3: {
          title: 'S3 对象存储',
          description: '配置并测试备份产物上传至标准 S3 对象存储。'
        },
        backup: {
          title: '备份操作',
          description: '触发 PostgreSQL、Redis 与整库备份任务。'
        },
        history: {
          title: '备份历史',
          description: '查看备份任务的执行状态、错误与产物信息。'
        }
      },
      form: {
        sourceMode: '源模式',
      ...
      s3Profiles: {
        ...
        editTitle: '编辑 S3 账号',
        empty: '当前没有 S3 账号，请先创建',
        editHint: '点击"编辑"会在右侧抽屉中修改账号信息。',
      ...
      actions: {
        ...
        testS3: '测试 S3 连接',
        s3TestOK: 'S3 连接测试通过',
        s3TestFailed: 'S3 连接测试未成功',
        newProfile: '新建账号',
        saveProfile: '存储账号',
        activateProfile: '设为激活',
        profileIDRequired: '请填写账号 ID',
        profileNameRequired: '请填写账号名称',
        profileSelectRequired: '请先选择要编辑的账号',
        profileCreated: 'S3 账号创建成功',
        profileSaved: 'S3 账号存储成功',
        profileActivated: 'S3 账号已切换为激活',
        profileDeleted: 'S3 账号已删除',
        sourceProfileCreated: '数据源配置创建成功',
        sourceProfileSaved: '数据源配置存储成功',
        sourceProfileActivated: '数据源配置已切换为激活',
        sourceProfileDeleted: '数据源配置已删除',
        createBackup: '创建备份任务',
    ...
    affiliates: {
      invitesDescription: '查看全站邀请关系及被邀请用户的累计返利',
      rebatesDescription: '查看每一笔产生返利的充值订单',
      transfersDescription: '查看返利额度转入账户余额的提取记录',
      errors: {
        loadFailed: '邀请返利记录加载未成功'
      },
      records: {
        search: '搜索',
    ...
    users: {
      ...
      editUser: '编辑用户',
      deleteUser: '删除用户',
      deleteConfirmMessage: "确定要删除用户 '{email}' 吗？该操作不可撤销。",
      ...
      enterEmail: '请填写邮箱',
      enterPassword: '请填写密码',
      enterUsername: '请填写用户名（选填）',
      enterNotes: '请填写备注（仅管理员可见）',
      notesHint: '此备注仅管理员可见',
      enterNewPassword: '请填写新密码（选填）',
      ...
      noApiKeys: '该用户当前没有 API 密钥',
      group: '分组',
      none: '无',
      groupChangedSuccess: '分组修改成功',
      groupChangedWithGrant: '分组修改成功，已自动为用户添加「{group}」分组权限',
      groupChangeFailed: '分组修改未成功',
      noUsersYet: '当前没有用户',
      createFirstUser: '创建你的第一个用户以开始使用系统',
      userCreated: '用户创建成功',
      userUpdated: '用户更新成功',
      userDeleted: '已删除用户',
      userEnabled: '用户已启用',
      userDisabled: '用户已禁用',
      failedToLoad: '用户列表加载未成功',
      failedToCreate: '创建用户未成功',
      failedToUpdate: '更新用户未成功',
      failedToDelete: '删除用户未成功',
      failedToToggle: '更新用户状态未成功',
      failedToLoadApiKeys: '用户 API 密钥加载未成功',
      deleteConfirm: "确定要删除用户 '{email}' 吗？该操作不可撤销。",
      roles: {
        admin: '管理员',
        user: '用户'
      },
      form: {
        ...
        usernameLabel: '用户名',
        usernamePlaceholder: '请填写用户名（选填）',
        notesLabel: '备注',
        notesPlaceholder: '请填写备注（仅管理员可见）',
        notesHint: '此备注仅管理员可见',
        passwordLabel: '密码',
        passwordPlaceholder: '请填写密码（留空则不修改）',
        roleLabel: '角色',
        selectRole: '选择角色',
        balanceLabel: '余额',
      ...
      adjustmentAmountHint: '正数为增加，负数为减少',
      currentBalance: '当前余额',
      currentConcurrency: '当前并发数',
      saving: '正在存储...',
      noUsers: '当前没有用户',
      noUsersDescription: '创建你的第一个用户以开始使用系统。',
      userCreatedSuccess: '用户创建成功',
      userUpdatedSuccess: '用户更新成功',
      userDeletedSuccess: '已删除用户',
      balanceAdjustedSuccess: '余额调整成功',
      concurrencyAdjustedSuccess: '并发数调整成功',
      failedToSave: '存储用户未成功',
      failedToAdjust: '调整未成功',
      emailRequired: '请填写邮箱',
      concurrencyMin: '并发数不能小于1',
      soraStorageQuota: 'Sora 存储配额',
      soraStorageQuotaHint: '单位 GB，0 表示使用分组或系统默认配额',
      amountRequired: '请填写有效金额',
      insufficientBalance: '余额不足',
      setAllowedGroups: '设置允许分组',
      allowedGroupsHint: '选择该用户可使用的标准分组。订阅类型分组请在订阅管理中配置。',
      noStandardGroups: '当前没有标准分组',
      allowAllGroups: '允许全部分组',
      allowAllGroupsHint: '用户可使用任何非专属分组',
      allowedGroupsUpdated: '允许分组更新成功',
      failedToLoadGroups: '分组列表加载未成功',
      failedToUpdateAllowedGroups: '更新允许分组未成功',
      // 用户分组配置
      groupConfig: '用户分组配置',
      ...
      customRate: '专属倍率',
      useDefaultRate: '使用默认',
      customRatePlaceholder: '留空则使用默认',
      groupConfigUpdated: '分组配置更新成功',
      replaceGroup: '替换分组',
      clickToReplace: '点击替换分组',
      replaceGroupTitle: '替换专属分组',
      replaceGroupHint: '选择新分组替换「{old}」，会自动迁移绑定的 Key 并更新分组权限',
      ...
      failedToDeposit: '充值未成功',
      failedToWithdraw: '退款未成功',
      useDepositWithdrawButtons: '请使用充值/退款按钮调整余额',
      // 余额变动记录
      balanceHistory: '充值记录',
      balanceHistoryTip: '点击查看充值记录',
      columnAlwaysVisible: '该列固定展示，不可隐藏',
      // 平台用量明细（悬浮显示）
      platformBreakdown: '按平台拆分',
      platformBreakdownEmpty: '当前没有平台明细',
      platformBreakdownHint: '悬浮查看各平台用量',
      platformOther: '其他',
      balanceHistoryTitle: '用户充值与并发变动记录',
      noBalanceHistory: '当前没有变动记录',
      allTypes: '全部类型',
      typeBalance: '余额（兑换码）',
      ...
      typeSubscription: '订阅',
      failedToLoadBalanceHistory: '余额记录加载未成功',
      createdAt: '创建时间',
      totalRecharged: '总充值',
      // Settings Dropdowns
      filterSettings: '筛选设置',
      ...
      attributes: {
        ...
        deleteConfirm: "确定要删除属性 '{name}' 吗？所有用户的该属性值都会被删除。",
        noAttributes: '当前没有自定义属性',
        noAttributesHint: '点击上方按钮添加自定义属性',
        key: '属性键',
        keyHint: '供程序引用，只能包含字母、数字和下划线',
        name: '显示名称',
        nameHint: '在表单中展示的名称',
        type: '属性类型',
        fieldDescription: '描述',
        ...
        deleted: '已删除属性',
        reordered: '属性排序更新成功',
        failedToLoad: '属性列表加载未成功',
        failedToCreate: '创建属性未成功',
        failedToUpdate: '更新属性未成功',
        keyRequired: '请填写属性键',
        nameRequired: '请填写显示名称',
        optionsRequired: '请至少添加一个选项',
        failedToDelete: '删除属性未成功',
        failedToReorder: '更新排序未成功',
        keyExists: '属性键已存在',
        dragToReorder: '拖拽排序'
      },
      platformQuota: {
        ...
        clearAllConfirm: '确认清空全部平台的日 / 周 / 月限额？所有平台将变为"无限额"，本地无法撤销，需在保存前手动重填。',
        reset: {
          button: '重置该窗口',
          confirm: '确认重置该用户 {platform} 平台的 {window} 用量？该操作立即生效。',
        ...
        subscriptionWarning: '该用户有活跃订阅，平台限额仅在余额（标准）模式下生效，订阅模式请求不受此限额约束。',
        invalidNumber: '以下字段填写的不是合法数字，请修正后再存储：{fields}',
      }
    },
    ...
    groups: {
      ...
      sortOrder: '排序',
      columnSettings: '列设置',
      sortOrderHint: '拖拽分组以调整显示顺序，排在前面的分组会优先展示',
      sortOrderUpdated: '排序已更新',
      failedToUpdateSortOrder: '更新排序未成功',
      deleteConfirm: "确定要删除分组 '{name}' 吗？所有关联的 API 密钥将不再属于任何分组。",
      deleteConfirmSubscription:
        "确定要删除订阅分组 '{name}' 吗？该操作会让所有绑定此订阅的用户的 API Key 失效，并删除所有相关订阅记录。该操作不可撤销。",
      columns: {
        name: '名称',
        platform: '平台',
        rateMultiplier: '费率倍数',
      ...
      form: {
        ...
        exclusive: '专属分组',
        nameLabel: '分组名称',
        namePlaceholder: '请填写分组名称',
        descriptionLabel: '描述',
        descriptionPlaceholder: '请填写描述（可选）',
      ...
      exclusive: '专属',
      exclusiveHint: '专属分组，可手动指定给特定用户',
      exclusiveTooltip: {
        title: '什么是专属分组？',
        description:
          '开启后，用户在创建 API Key 时将看不到此分组。只有管理员手动将用户分配到此分组后，用户才能使用。',
        example: '使用场景：',
        exampleContent:
          '公开分组费率 0.8，你可以创建一个费率 0.7 的专属分组，手动分配给 VIP 用户，让其享受更优惠的价格。'
      },
      rateMultiplierHint: '1.0 = 标准费率，0.5 = 半价，2.0 = 双倍',
      platforms: {
        all: '全部平台',
      ...
      saving: '正在存储...',
      noGroups: '当前没有分组',
      noGroupsDescription: '创建分组以便更好地管理 API 密钥与费率。',
      groupCreatedSuccess: '分组创建成功',
      groupUpdatedSuccess: '分组更新成功',
      groupDeletedSuccess: '已删除分组',
      failedToLoad: '分组列表加载未成功',
      failedToSave: '存储分组未成功',
      failedToDelete: '删除分组未成功',
      allPlatforms: '全部平台',
      allStatus: '全部状态',
      allGroups: '全部分组',
      exclusiveFilter: '专属',
      ...
      accountFilters: {
        ...
        privacySetOnly: '仅允许已设置隐私保护的账号',
        privacySetOnlyEnabled: '已启用 — 未设置 Privacy 的账号将被排除',
        disabled: '未启用'
      },
      enterGroupName: '请填写分组名称',
      optionalDescription: '可选描述',
      platformHint: '选择该分组关联的平台',
      platformNotEditable: '创建后不可更改平台',
      noGroupsYet: '当前没有分组',
      createFirstGroup: '创建你的第一个分组来组织 API 密钥。',
      creating: '正在创建...',
      updating: '正在更新...',
      limitDay: '日',
      limitWeek: '周',
      ...
      groupUpdated: '分组更新成功',
      groupDeleted: '已删除分组',
      failedToCreate: '创建分组未成功',
      failedToUpdate: '更新分组未成功',
      ...
      noRpmOverrides: '当前没有用户设置专属 RPM',
      rpmSaved: '专属 RPM 已存储',
      groupRpmDefault: '分组默认 RPM',
      searchUserPlaceholder: '搜索用户邮箱...',
      noRateMultipliers: '当前没有用户设置专属倍率',
      rateUpdated: '专属倍率已更新',
      rateDeleted: '专属倍率已删除',
      rateAdded: '专属倍率已添加',
      clearAll: '全部清空',
      confirmClearAll: '确定要清空该分组所有用户的专属倍率设置吗？该操作不可撤销。',
      ...
      rateSaved: '专属倍率已存储',
      finalRate: '最终倍率',
      unsavedChanges: '存在未存储的修改',
      revertChanges: '撤销修改',
      userInfo: '用户信息',
      subscription: {
        title: '订阅设置',
        type: '计费类型',
        typeHint: '标准计费从用户余额扣除。订阅模式采用配额限制。',
      ...
      imagePricing: {
        title: '图片生成计费',
        description: '配置图片生成能力与图片基础单价，留空则采用默认价格',
        ...
        batchSectionHint: '批量生图仅影响批量任务：结算价格会叠加批量折扣倍率，提交时冻结金额按普通生图原价 × 批量冻结价格比例计算。参考图同样会产生上游输入 token 消耗，建议批量生图折扣倍率设置大于 0.5。',
      ...
      videoPricing: {
        title: '视频生成计费',
        description:
          '配置 Grok 视频生成的每秒单价（USD/秒），留空则采用默认每秒价（grok-imagine-video：480p $0.05/s、720p $0.07/s；video-1.5：480p $0.08/s、720p $0.14/s、1080p $0.25/s）',
      ...
      modelsList: {
        ...
        hint: '仅影响 /v1/models 的展示结果，不影响白名单模型调用与账号调度。',
        loading: '正在加载模型列表...',
        empty: '当前没有可展示模型',
      ...
      claudeCode: {
        ...
        tooltip:
          '启用后，该分组仅允许 Claude Code 官方客户端访问。非 Claude Code 请求会被拒绝或降级到指定分组。',
        enabled: '仅限 Claude Code',
        disabled: '允许所有客户端',
        fallbackGroup: '降级分组',
        fallbackHint: '非 Claude Code 请求会使用此分组，留空则直接拒绝',
        noFallback: '不降级（直接拒绝）'
      },
      openaiMessages: {
        title: 'OpenAI Messages 调度配置',
        allowDispatch: '允许 /v1/messages 调度',
        allowDispatchHint: '启用后，该 OpenAI 分组的 API Key 可通过 /v1/messages 端点调度请求',
        ...
        exactMappingHint: '精确 Claude 模型覆盖的优先级高于系列默认映射，可将某个具体 Claude 模型单独映射到不同的目标模型。',
        noExactMappings: '当前没有精确模型覆盖规则',
      ...
      copyAccounts: {
        ...
        hint: '可选多个分组，账号会自动去重',
        hintEdit: '⚠️ 注意：该操作会替换当前分组的所有账号绑定'
      },
      modelRouting: {
        title: '模型路由配置',
        tooltip:
      ...
      supportedScopes: {
        title: '支持的模型系列',
        tooltip: '选择该分组支持的模型系列。未勾选的系列不会被路由到此分组。',
        claude: 'Claude',
