export default {
    ops: {
      ...
      systemLogs: {
        title: '系统日志',
        description: '优先展示最新日志，可按条件筛选、检索和清理。',
        queue: '队列',
        written: '已写入',
        dropped: '已丢弃',
        failed: '写入未成功',
      ...
      failedToLoadData: '运维数据加载未成功',
      failedToLoadOverview: '概览数据加载未成功',
      failedToLoadThroughputTrend: '吞吐趋势加载未成功',
      failedToLoadSwitchTrend: '平均账号切换趋势加载未成功',
      failedToLoadLatencyHistogram: '请求时长分布加载未成功',
      failedToLoadErrorTrend: '错误趋势加载未成功',
      failedToLoadErrorDistribution: '错误分布加载未成功',
      failedToLoadErrorDetail: '错误详情加载未成功',
      retryFailed: '重试未成功',
      tpsK: 'TPS（千）',
      top: '最高：',
      ...
      healthHelp: '基于 SLA、错误率及资源使用情况的系统整体健康评分',
      healthyStatus: '健康',
      riskyStatus: '风险',
      idleStatus: '待机',
      timeRange: {
      ...
      openaiTokenStats: {
        ...
        failedToLoad: 'OpenAI Token 统计加载未成功',
        empty: '当前筛选条件下没有 OpenAI Token 请求统计数据',
        table: {
          model: '模型',
          requestCount: '请求数',
      ...
      diagnosis: {
        ...
        dbDownAction: '检查数据库服务状态、网络连接及连接配置',
        redisDown: 'Redis连接未成功',
        redisDownImpact: '缓存功能降级，性能可能下降',
        redisDownAction: '检查Redis服务状态及网络连接',
        ...
        errorElevatedAction: '分析错误类型及分布，制定修复计划',
        // SLA diagnostics
      ...
      errorDetails: {
        ...
        total: '总计：',
        searchPlaceholder: '检索 request_id / client_request_id / message'
      },
      // Error Detail Modal
      errorDetail: {
        title: '错误详情',
        ...
        resolution: '已解决：',
        failedToUpdateResolvedStatus: '更新解决状态未成功',
        classificationKeys: {
          phase: '阶段',
          owner: '归属方',
          source: '来源',
      ...
      alertEvents: {
        ...
        detail: {
          ...
          loading: '正在加载详情...',
          empty: '当前没有详情',
          loadFailed: '告警详情加载未成功',
          manualResolve: '标记为已解决',
          manualResolvedSuccess: '已标记为手动解决',
          manualResolvedFailed: '标记为手动解决未成功',
          silence: '忽略此告警',
      ...
      alertRules: {
        ...
        loading: '正在加载...',
        empty: '当前没有告警规则',
        loadFailed: '告警规则加载未成功',
        saveSuccess: '警报规则保存完成',
        saveFailed: '告警规则保存未成功',
        deleteSuccess: '警报规则已删除',
        deleteFailed: '告警规则删除未成功',
        create: '新建规则',
        createTitle: '新建告警规则',
        editTitle: '编辑告警规则',
      ...
      runtime: {
        ...
        loading: '正在加载...',
        noData: '当前没有运行设置',
        loadFailed: '运行设置加载未成功',
        saveSuccess: '运行设置已保存',
        saveFailed: '运行设置保存未成功',
        alertTitle: '告警评估器',
      ...
      email: {
        ...
        loading: '正在加载...',
        noData: '当前没有邮件通知配置',
        loadFailed: '邮件通知配置加载未成功',
        saveSuccess: '邮件通知配置已保存',
        saveFailed: '邮件通知配置保存未成功',
        alertTitle: '告警邮件',
        reportTitle: '报告邮件',
        recipients: '收件人',
      ...
      concurrency: {
        ...
        byAccount: '按账号',
        byUser: '按用户',
        showByUserTooltip: '切换用户视图，展示每个用户的并发使用情况',
      ...
      tooltips: {
        totalRequests: '当前时间窗口内的总请求数及Token消耗量。',
        ...
        cpu: 'CPU 使用率，展示系统处理器的负载情况。',
        memory: '内存使用率，包括已使用及总可用内存。',
        db: '数据库连接池状态，包括活跃连接、空闲连接及等待连接数。',
        redis: 'Redis 连接池状态，展示活跃及空闲的连接数。',
        jobs: '后台任务执行状态，包括最近运行时间、成功时间及错误信息。',
        qps: '每秒查询数（QPS）及每秒Token数（TPS），实时展示系统吞吐量。',
        tokens: '当前时间窗口内处理的总Token数量。',
        sla: '服务等级协议达成率，排除业务限制（如余额不足、配额超限）的成功请求占比。',
        errors: '错误统计，包括总错误数、错误率及上游错误率。',
        latency: '请求时长统计，包括 p50、p90、p95、p99 等百分位数。',
        ttft: '首 Token 延迟（Time To First Token），衡量流式响应的首 Token 返回速度。',
        health: '系统健康评分（0-100），综合考虑 SLA、错误率及资源使用情况。'
      },
      charts: {
        emptyRequest: '该时间窗口内没有请求。',
        emptyError: '该时间窗口内没有错误。',
        resetZoom: '重置',
