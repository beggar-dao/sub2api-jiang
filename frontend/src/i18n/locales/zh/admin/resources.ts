export default {
    scheduledTests: {
      ...
      cronTooltipMeaning: '用于定义自动执行测试的时间规则，字段顺序依次为：分钟 小时 日 月 星期。',
      ...
      cronTooltipRange: '推荐填写范围：使用标准 5 字段 cron；若仅用于健康检查，建议从每 30 分钟、每 1 小时或每天固定时间起步，不建议一开始就设置过高频率。',
      maxResultsTooltipTitle: '最大结果数说明：',
      maxResultsTooltipMeaning: '用于限制单个计划最多保留多少条历史测试结果，避免结果列表无限增长。',
      maxResultsTooltipBody: '系统仅保留最近的测试结果；当保存数量超过该值时，更早的历史记录会自动清理，避免列表过长以及存储持续增长。',
      ...
      autoRecover: '自动恢复',
      autoRecoverHelp: '测试成功后自动恢复处于异常状态的账号'
    },
    ...
    proxies: {
      ...
      testProxy: '测试代理',
      dataImport: '导入',
      dataExportSelected: '导出所选',
      dataImportTitle: '导入代理',
      dataImportHint: '上传代理导出的 JSON 文件，即可批量导入代理。',
      dataImportWarning: '导入时会创建或复用代理，保留原有状态，并在完成后自动触发延迟检测。',
      dataImportFile: '数据文件',
      ...
      noProxiesYet: '当前没有代理',
      createFirstProxy: '添加您的第一个代理即可开始使用。',
      testConnection: '测试连接',
      qualityCheck: '质量检测',
      ...
      testFailed: '失败',
      latencyFailed: '链接失败',
      batchTestEmpty: '当前没有可测试的代理',
      batchTestDone: '批量测试完成，共测试 {count} 个代理',
      batchTestFailed: '批量测试失败',
      batchDeleteAction: '删除',
      batchDelete: '批量删除',
      batchDeleteConfirm: '确定要删除选中的 {count} 个代理吗？已被账号使用的将自动跳过。',
      batchDeleteDone: '已删除 {deleted} 个代理，跳过 {skipped} 个',
      batchDeleteSkipped: '已跳过 {skipped} 个代理',
      batchDeleteFailed: '批量删除失败',
      deleteBlockedInUse: '该代理已有账号在使用，无法删除',
      accountsTitle: '使用该 IP 的账号',
      accountsEmpty: '当前没有账号使用此代理',
      ...
      updating: '正在更新...',
      noProxies: '当前没有代理',
      noProxiesDescription: '添加代理服务器以提升 API 访问的稳定性。',
      proxyCreated: '代理添加成功',
      proxyUpdated: '代理更新成功',
      proxyDeleted: '代理删除成功',
      proxyWorking: '代理连接正常',
      ...
      batchQualityEmpty: '当前没有可检测质量的代理',
      ...
      portInvalid: '端口须在 1-65535 之间',
      deleteConfirm: "确定要删除代理 '{name}' 吗？使用该代理的账号将被移除代理设置。",
      neverExpires: '永不过期',
      expired: '已过期',
    ...
    redeem: {
      ...
      subscription: '订阅',
      invitation: '邀请码',
      invitationHint: '邀请码用于限制用户注册，使用后将自动标记为已使用。',
      allTypes: '全部类型',
      allStatus: '全部状态',
      unused: '未使用',
      used: '已使用',
      ...
      noBatchFieldsSelected: '请至少勾选一个需要修改的字段',
      ...
      batchNotesPlaceholder: '请输入新的备注，留空可清空备注',
      clearGroup: '清空分组',
      deleteAllUnused: '删除全部未使用',
      deleteCodeConfirm: '确定要删除该兑换码吗？此操作无法撤销。',
      ...
      enableCode: '启用',
      deleteCode: '删除',
      deleteConfirmMessage: '确定要删除该兑换码吗？',
      noCodes: '当前没有兑换码',
      noCodesDescription: '生成兑换码即可向用户分发余额或并发数。',
    ...
    promo: {
      ...
      codeUpdated: '优惠码更新成功',
      codeDeleted: '优惠码删除成功',
      deleteCodeConfirm: '确定要删除该优惠码吗？此操作无法撤销。',
      copyRegisterLink: '复制注册链接',
      registerLinkCopied: '注册链接已复制至剪贴板',
    ...
    usage: {
      ...
      tokenRanking: {
        subtitle: '按当前筛选与时间范围，统计每位用户的 Token 用量',
        rowHint: '点击可查看该用户的用量明细',
      ...
      cleanup: {
        button: '清理',
        title: '清理使用记录',
        warning: '清理操作不可恢复，且会影响历史统计的回看。',
        submit: '提交清理',
        submitting: '正在提交...',
        confirmTitle: '确认清理',
        confirmMessage: '确定要提交清理任务吗？清理后不可恢复。',
        confirmSubmit: '确认清理',
        cancel: '取消任务',
