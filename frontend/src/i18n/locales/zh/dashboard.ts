export default {
  dashboard: {
    ...
    platformBreakdownEmpty: '当前没有平台用量',
    ...
    startUsingApi: '开始使用 API 后，您的使用历史将展示在这里。',
    viewAllUsage: '查看全部',
    quickActions: '快捷操作',
  ...
  keys: {
    title: 'API 密钥',
    description: '管理您的 API 密钥及访问令牌',
    searchPlaceholder: '检索名称或Key...',
    endpoints: {
      title: 'API 端点',
      default: '默认',
      copied: '已复制',
    ...
    selectStatus: '选择状态',
    saving: '保存中...',
    noKeysYet: '当前没有 API 密钥',
    createFirstKey: '创建您的第一个 API 密钥以开始使用 API。',
    keyCreatedSuccess: 'API 密钥创建完成',
    keyUpdatedSuccess: 'API 密钥更新完成',
    keyDeletedSuccess: 'API 密钥已删除',
    keyEnabledSuccess: 'API 密钥已启用',
    keyDisabledSuccess: 'API 密钥已禁用',
    failedToLoad: 'API 密钥加载未成功',
    failedToSave: 'API 密钥保存未成功',
    failedToDelete: 'API 密钥删除未成功',
    failedToUpdateStatus: 'API 密钥状态更新未成功',
    clickToChangeGroup: '点击更换分组',
    groupChangedSuccess: '分组更换完成',
    failedToChangeGroup: '更换分组未成功',
    groupRequired: '请选择分组',
    usage: '用量',
    today: '今日',
    total: '近30天',
    ...
    useKeyModal: {
      title: '使用 API 密钥',
      description: '将以下环境变量添加到您的终端配置文件，或直接在终端中运行。',
      copy: '复制',
      copied: '已复制',
      ...
      gemini: {
        description:
          '将以下环境变量添加到您的终端配置文件，或直接在终端中运行，以配置 Gemini CLI 访问。',
    ...
    customKeyPlaceholder: '填写自定义密钥（至少16个字符）',
    customKeyHint: '仅允许字母、数字、下划线及连字符，最少16个字符。',
    customKeyTooShort: '自定义密钥至少需要16个字符',
    customKeyInvalidChars: '自定义密钥只能包含字母、数字、下划线及连字符',
    customKeyRequired: '请填写自定义密钥',
    ipRestriction: 'IP 限制',
    ipWhitelist: 'IP 白名单',
    ...
    quotaAmountPlaceholder: '填写 USD 额度限制',
    ...
    quotaResetSuccess: '额度重置完成',
    failedToResetQuota: '额度重置未成功',
    ...
    failedToResetRateLimit: '速率限制重置未成功',
    resetNow: '即将重置',
    expiration: '密钥有效期',
  ...
  usage: {
    ...
    failedToLoad: '使用记录加载未成功',
    noDataToExport: '没有可导出的数据',
    exportSuccess: '使用数据导出完成',
    exportFailed: '使用数据导出未成功',
    exportExcelSuccess: '使用数据导出完成（Excel格式）',
    exportExcelFailed: '使用数据导出未成功',
    imageUnit: '张',
    ...
    errors: {
      ...
      modelPlaceholder: '检索模型', allCategories: '全部分类', allStatuses: '所有状态码',
      empty: '当前没有错误请求', failedToLoad: '错误请求加载未成功',
      categories: {
  ...
  channelStatus: {
    title: '渠道状态',
    description: '查看渠道可用性、延迟及近期状态',
    searchPlaceholder: '检索渠道...',
    allProviders: '所有供应商',
    loadError: '渠道状态加载未成功',
    detailLoadError: '渠道详情加载未成功',
    detailTitle: '渠道详情',
    closeDetail: '关闭',
    windowTab: {
      '7d': '7 天',
  ...
  availableChannels: {
    title: '可使用渠道',
    description: '查看您可访问的渠道及其支持的模型、定价',
  ...
  affiliate: {
    ...
    codeCopied: '邀请码已复制',
    linkCopied: '邀请链接已复制',
    loadFailed: '邀请返利数据加载未成功',
    transferFailed: '转入余额未成功',
    stats: {
      rebateRate: '我的返利比例',
  ...
  redeem: {
    title: '兑换码',
    description: '填写兑换码以充值余额或增加并发数',
    currentBalance: '当前余额',
    concurrency: '并发数',
    requests: '请求',
    redeemCodeLabel: '兑换码',
    redeemCodePlaceholder: '请填写兑换码',
    ...
    recentActivity: '最近活动',
    historyWillAppear: '您的兑换历史将展示在这里',
    ...
    failedToRedeem: '兑换未成功，请检查兑换码后重试。',
    subscriptionRefreshFailed: '兑换成功，但订阅状态刷新未成功。',
    pleaseEnterCode: '请填写兑换码'
  },

  // Profile
  profile: {
    title: '个人设置',
    description: '管理您的账户信息及设置',
    accountBalance: '账户余额',
    ...
    updateProfile: '更新资料',
    updating: '更新中...',
    updateSuccess: '资料更新完成',
    updateFailed: '资料更新未成功',
    ...
    passwordsNotMatch: '两次填写的密码不一致',
    passwordTooShort: '密码至少需要 8 个字符',
    passwordChangeSuccess: '密码修改完成',
    passwordChangeFailed: '密码修改未成功',
    // TOTP 2FA
    totp: {
      title: '双因素认证 (2FA)',
    ...
    balanceNotify: {
      ...
      thresholdPlaceholder: '填写金额',
      systemDefault: '系统默认值',
      extraEmails: '通知邮箱',
      extraEmailsHint: '必须添加并验证邮箱后，余额不足时才能收到提醒邮件',
      primaryEmail: '主邮箱',
      noExtraEmails: '当前没有额外通知邮箱',
      enterEmail: '填写邮箱地址',
      addEmail: '添加邮箱',
      emailPlaceholder: '填写邮箱地址',
      sendCode: '发送验证码',
      resend: '重发',
      codeSent: '验证码已发送',
    ...
    avatar: {
      ...
      compressFailed: '所选图片压缩未成功',
      readFailed: '所选图片读取未成功',
    ...
    authBindings: {
      ...
      replaceEmailPasswordPlaceholder: '填写当前密码',
